...
$(function($){
	$("#ajax_loading").ajaxStart(function(){
		...
		$(this).hide();
              ...
              </td></tr><tr><th width="100">网站地图(xml) :</th><td><a id="down" href="<?php echo U('Sitemap/xml');?>">生成sitemap.xml</a></td></tr><tr><th width="100">网站地图(html) :</th><td><a id="down" href="<?php echo U('Sitemap/html');?>">生成sitemap.html</a></td></tr></table></div><div id="div_setting_3" class="contentList pad-10 hidden"><table width="100%" cellpadding="2" cellspacing="1" class="table_form"><tr><th width="100">网站状态 :</th><td><input type="radio" <?php if($set["site_status"] == '1'): ?>checked="checked"<?php endif; ?> onclick="" value="1" name="site[site_status]"> 开启 &nbsp;&nbsp;
